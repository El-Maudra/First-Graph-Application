...
class DrawingApplication(tkinter.Frame):
    ...
    def buildWindow(self):
        ...
        def loadFile():
            filename = tkinter.filedialog.askopenfilename("Select a Graphics file: ")
        ...
        def SaveFile():
            filename = tkinter.filedialog.asksaveasfilename("Save Picture As...")
            write(filename)
